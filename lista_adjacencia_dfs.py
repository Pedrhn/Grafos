...
def main():
    ...
    while True:
        ...
        if opcao == "1":
            ...
            print("Ordem da busca em profundidade:")
            busca_em_profundidade(grafo, inicio)
            print()
        elif opcao == "11":
            print("Ciclo detectado?" , "Sim" if detectar_ciclo(grafo) else "Não")
        elif opcao == "0":
            print("Encerrando...")
            break
        else:
